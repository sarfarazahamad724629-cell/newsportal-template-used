...
const ENationalElectronicsBanner = () => {
  ...
  (async () => {
    try {
      ...
      // 🔒 safest way to get anime function
      const animeFn =
        typeof mod === "function"
          ? mod
          : typeof mod.default === "function"
          ? mod.default
          : typeof mod.anime === "function"
          ? mod.anime
          : null;

      if (!animeFn || !mounted) return;

      // 🔹 Animation 1 (row svg – SAME AS ORIGINAL)
      anim1 = animeFn({
        targets: ".row svg",
        translateY: 10,
        autoplay: true,
      ...
      // 🔹 Animation 2 (#zero – SAME + scale + rotateY)
      anim2 = animeFn({
        targets: "#zero",
        translateX: 10,
        autoplay: true,
  ...
  // 🧹 cleanup (route change / strict mode safe)
  return () => {
    mounted = false;
    anim1?.pause();
    anim2?.pause();
...
export default ENationalElectronicsBanner;
